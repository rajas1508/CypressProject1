describe ('MANAGER LEAVE REPORT', () =>
{

    it('MANAGER LEAVE REPORT', () =>
    {
                ...
                cy.wait(4000)
                cy.xpath('//span[text()=" Mgr Leave Report"]')                                                              //Click on MANAGER Leave report menu and validate
                  .click()
                cy.log('Manager Leave report menu button validated')

                cy.xpath('//*[@class="icon-file-excel"]/parent::span').click()
                cy.xpath('//*[@class="icon-file-pdf"]/parent::span').click().wait(3000)
