describe ('LEAVE MANAGEMENT MANAGER LEAVE  DASHBOARD', () =>
{

    it('MANAGER LEAVE DASHBOARD', () =>
    {
        ...
        cy.wait(4000)
        cy.xpath('(//span[text()=" Leave Dashboard Mgr"])[1]')                                                          //Click on MANAGER Leave report menu and validate
          .click()
